<?php
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id']; 
        $data_kategori = $lib->get_by_id($id);
        $nm_kategori = $data_kategori['Nama'];
    }
    else{
    ...
    if(isset($_POST['submit'])){
        ...
        $status_update = $lib->update($id,$nm_kategori);
        if($status_update)
        {
            header('Location: KategoriDisplay.php');
        }
...
<body>
                ...
                <div id="KategoriModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h2 class="ModalTittle">Kategori</h2>
                        </div>

                        <div class="modal-body">
                        <form class="input-form" method="POST" role="form">
                                <label for="itemID">Kategori ID : <?php echo $id ?> </label>
                                <input class="nama" id="nama" name="nm_kategori" type="text" placeholder="<?php echo $nm_kategori ?>">
    ...
    <script>
        ...
        //     window.location = "KategoriDisplay.php";
        // }
        // ======================================================
        // About Modal Box
        // Get the modal
