            ...
            <div class="card-body">
              <div class="table-responsive">
							...
							<?php
								...
								$sql = $koneksi->query("insert into barang_keluar (id_transaksi, tanggal, kode_barang, nama_barang, jumlah,  satuan, tujuan,id_rak) values('$id_transaksi','$tanggal','$kode_barang','$nama_barang','$jumlah','$satuan','$tujuan','$id_rak')");
